...
import { Book, Bot, Code2, CornerDownLeft, LifeBuoy, Mic, Paperclip, Settings, Settings2, Share, SquareTerminal, SquareUser, Triangle } from 'lucide-vue-next'
...
<template>
  <div class="grid h-screen w-full pl-[53px]">
    <aside class="fixed top-0 left-0 z-20 flex flex-col h-full border-t border-r inset-y bg-[hsl(var(--background))]">
...
xxx
        ...
        <div class="relative flex h-full min-h-[25vh] max-h-[75vh] flex-col rounded-xl bg-muted/50 p-4 lg:col-span-2">
