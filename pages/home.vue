...
<template>
  <div class="px-4 mx-auto text-center max-w-7xl sm:px-6 lg:px-8 lg:pt-32">
    <h1 class="max-w-4xl mx-auto text-5xl font-medium tracking-tight font-display sm:text-7xl">Chat
    ...
    <blockquote class="max-w-2xl mx-auto mt-12 text-lg tracking-tight text-slate-600">
      You have to sign up to use the service, so that it doesn't get abused. Your password and email will be encrypted.
    </blockquote>
