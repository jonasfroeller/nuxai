    ...
    async onSuccess(event, { user, tokens }) {
        ...
        await setUserSession(event, {
            user: {
                ...
                oauth: {
                    google: {
                        google_id: createdOrFetchedUserAndConnectedOauthAccount.userData.oauth_user_id,
                        google_email: createdOrFetchedUserAndConnectedOauthAccount.userData.oauth_email
                    }
                }
            },
            loggedInAt: new Date()
